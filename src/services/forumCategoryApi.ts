...
export class ForumCategoryApiService {
  ...
  getAllCategorySubCategory(responsePayload: any, params: any): Promise<any> {
    var query = this.makeRequest.makeRequest(
      "query",
      "retrieveAllCategorySubCategory",
      responsePayload,
      params
    );
    return new Promise((resolve, reject) => {
  ...
  getAllThreadPostComment(responsePayload: any, params: any): Promise<any> {
    var query = this.makeRequest.makeRequest(
      "query",
      "retrieveAllThreadPostComment",
      responsePayload,
      params
    );
    return new Promise((resolve, reject) => {
      this.http
        ...
        .subscribe(
          json => {
            if (json["status"] == "success") {
              resolve({
                data: json["data"].retrieveAllThreadPostComment,
                meta: json["meta"]
              });
            }
          },
